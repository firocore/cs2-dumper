...
namespace C_Inferno {
   ...
   constexpr ptrdiff_t m_fireXDelta = 0xd04;
   constexpr ptrdiff_t m_fireYDelta = 0xe04;
   constexpr ptrdiff_t m_fireZDelta = 0xf04;
   constexpr ptrdiff_t m_fireParentXDelta = 0x1004;
   constexpr ptrdiff_t m_fireParentYDelta = 0x1104;
   constexpr ptrdiff_t m_fireParentZDelta = 0x1204;
...
namespace C_PlantedC4 {
   ...
   constexpr ptrdiff_t m_bTenSecWarning = 0xec0;
   constexpr ptrdiff_t m_bTriggerWarning = 0xec4;
   constexpr ptrdiff_t m_bExplodeWarning = 0xec8;
   constexpr ptrdiff_t m_bC4Activated = 0xecc;
   constexpr ptrdiff_t m_flDefuseLength = 0xed0;
   constexpr ptrdiff_t m_flDefuseCountDown = 0xed4;
   constexpr ptrdiff_t m_bBombDefused = 0xed8;
   constexpr ptrdiff_t m_hBombDefuser = 0xedc;
   constexpr ptrdiff_t m_hControlPanel = 0xee0;
   constexpr ptrdiff_t m_hDefuserMultimeter = 0xee4;
   constexpr ptrdiff_t m_flNextRadarFlashTime = 0xee8;
   constexpr ptrdiff_t m_bRadarFlash = 0xeec;
   constexpr ptrdiff_t m_pBombDefuser = 0xef0;
   constexpr ptrdiff_t m_fLastDefuseTime = 0xef4;
...
namespace C_CSWeaponBase {
   ...
   constexpr ptrdiff_t m_bVisualsDataSet = 0x1720;
   constexpr ptrdiff_t m_bOldFirstPersonSpectatedState = 0x1721;
   constexpr ptrdiff_t m_hOurPing = 0x1724;
   constexpr ptrdiff_t m_nOurPingIndex = 0x1728;
   constexpr ptrdiff_t m_vecOurPingPos = 0x172c;
   constexpr ptrdiff_t m_bGlowForPing = 0x1738;
   constexpr ptrdiff_t m_bUIWeapon = 0x1739;
   constexpr ptrdiff_t m_hPrevOwner = 0x1748;
   constexpr ptrdiff_t m_nDropTick = 0x174c;
   constexpr ptrdiff_t m_donated = 0x176c;
   constexpr ptrdiff_t m_fLastShotTime = 0x1770;
   constexpr ptrdiff_t m_bWasOwnedByCT = 0x1774;
   constexpr ptrdiff_t m_bWasOwnedByTerrorist = 0x1775;
   constexpr ptrdiff_t m_gunHeat = 0x1778;
   constexpr ptrdiff_t m_smokeAttachments = 0x177c;
   constexpr ptrdiff_t m_lastSmokeTime = 0x1780;
   constexpr ptrdiff_t m_flLastClientFireBulletTime = 0x1784;
...
namespace C_CSPlayerPawnBase {
   ...
   constexpr ptrdiff_t m_unTotalRoundDamageDealt = 0x13a8;
   constexpr ptrdiff_t m_fMolotovUseTime = 0x13ac;
   constexpr ptrdiff_t m_fMolotovDamageTime = 0x13b0;
   constexpr ptrdiff_t m_nWhichBombZone = 0x13b4;
   constexpr ptrdiff_t m_bInNoDefuseArea = 0x13b8;
   constexpr ptrdiff_t m_iThrowGrenadeCounter = 0x13bc;
   constexpr ptrdiff_t m_bWaitForNoAttack = 0x13c0;
   constexpr ptrdiff_t m_flGuardianTooFarDistFrac = 0x13c4;
   constexpr ptrdiff_t m_flDetectedByEnemySensorTime = 0x13c8;
   constexpr ptrdiff_t m_flNextGuardianTooFarWarning = 0x13cc;
   constexpr ptrdiff_t m_bSuppressGuardianTooFarWarningAudio = 0x13d0;
   constexpr ptrdiff_t m_bKilledByTaser = 0x13d1;
   constexpr ptrdiff_t m_iMoveState = 0x13d4;
   constexpr ptrdiff_t m_bCanMoveDuringFreezePeriod = 0x13d8;
   constexpr ptrdiff_t m_flLowerBodyYawTarget = 0x13dc;
   constexpr ptrdiff_t m_bStrafing = 0x13e0;
   constexpr ptrdiff_t m_flLastSpawnTimeIndex = 0x13e4;
   constexpr ptrdiff_t m_flEmitSoundTime = 0x13e8;
   constexpr ptrdiff_t m_iAddonBits = 0x13ec;
   constexpr ptrdiff_t m_iPrimaryAddon = 0x13f0;
   constexpr ptrdiff_t m_iSecondaryAddon = 0x13f4;
   constexpr ptrdiff_t m_iProgressBarDuration = 0x13f8;
   constexpr ptrdiff_t m_flProgressBarStartTime = 0x13fc;
   constexpr ptrdiff_t m_iDirection = 0x1400;
   constexpr ptrdiff_t m_iShotsFired = 0x1404;
   constexpr ptrdiff_t m_bNightVisionOn = 0x1408;
   constexpr ptrdiff_t m_bHasNightVision = 0x1409;
   constexpr ptrdiff_t m_flVelocityModifier = 0x140c;
   constexpr ptrdiff_t m_flHitHeading = 0x1410;
   constexpr ptrdiff_t m_nHitBodyPart = 0x1414;
   constexpr ptrdiff_t m_iStartAccount = 0x1418;
   constexpr ptrdiff_t m_vecIntroStartEyePosition = 0x141c;
   constexpr ptrdiff_t m_vecIntroStartPlayerForward = 0x1428;
   constexpr ptrdiff_t m_flClientDeathTime = 0x1434;
   constexpr ptrdiff_t m_flNightVisionAlpha = 0x1438;
   constexpr ptrdiff_t m_bScreenTearFrameCaptured = 0x143c;
   constexpr ptrdiff_t m_flFlashBangTime = 0x1440;
   constexpr ptrdiff_t m_flFlashScreenshotAlpha = 0x1444;
   constexpr ptrdiff_t m_flFlashOverlayAlpha = 0x1448;
   constexpr ptrdiff_t m_bFlashBuildUp = 0x144c;
   constexpr ptrdiff_t m_bFlashDspHasBeenCleared = 0x144d;
   constexpr ptrdiff_t m_bFlashScreenshotHasBeenGrabbed = 0x144e;
   constexpr ptrdiff_t m_flFlashMaxAlpha = 0x1450;
   constexpr ptrdiff_t m_flFlashDuration = 0x1454;
   constexpr ptrdiff_t m_lastStandingPos = 0x1458;
   constexpr ptrdiff_t m_vecLastMuzzleFlashPos = 0x1464;
   constexpr ptrdiff_t m_angLastMuzzleFlashAngle = 0x1470;
   constexpr ptrdiff_t m_hMuzzleFlashShape = 0x147c;
   constexpr ptrdiff_t m_iHealthBarRenderMaskIndex = 0x1480;
   constexpr ptrdiff_t m_flHealthFadeValue = 0x1484;
   constexpr ptrdiff_t m_flHealthFadeAlpha = 0x1488;
   constexpr ptrdiff_t m_nMyCollisionGroup = 0x148c;
   constexpr ptrdiff_t m_ignoreLadderJumpTime = 0x1490;
   constexpr ptrdiff_t m_ladderSurpressionTimer = 0x1498;
   constexpr ptrdiff_t m_lastLadderNormal = 0x14b0;
   constexpr ptrdiff_t m_lastLadderPos = 0x14bc;
   constexpr ptrdiff_t m_flDeathCCWeight = 0x14d0;
   constexpr ptrdiff_t m_bOldIsScoped = 0x14d4;
   constexpr ptrdiff_t m_flPrevRoundEndTime = 0x14d8;
   constexpr ptrdiff_t m_flPrevMatchEndTime = 0x14dc;
   constexpr ptrdiff_t m_unCurrentEquipmentValue = 0x14e0;
   constexpr ptrdiff_t m_unRoundStartEquipmentValue = 0x14e2;
   constexpr ptrdiff_t m_unFreezetimeEndEquipmentValue = 0x14e4;
   constexpr ptrdiff_t m_vecThirdPersonViewPositionOverride = 0x14e8;
   constexpr ptrdiff_t m_nHeavyAssaultSuitCooldownRemaining = 0x14f4;
   constexpr ptrdiff_t m_ArmorValue = 0x14f8;
   constexpr ptrdiff_t m_angEyeAngles = 0x1500;
   constexpr ptrdiff_t m_fNextThinkPushAway = 0x1518;
   constexpr ptrdiff_t m_bShouldAutobuyDMWeapons = 0x151c;
   constexpr ptrdiff_t m_bShouldAutobuyNow = 0x151d;
   constexpr ptrdiff_t m_bHud_MiniScoreHidden = 0x151e;
   constexpr ptrdiff_t m_bHud_RadarHidden = 0x151f;
   constexpr ptrdiff_t m_nLastKillerIndex = 0x1520;
   constexpr ptrdiff_t m_nLastConcurrentKilled = 0x1524;
   constexpr ptrdiff_t m_nDeathCamMusic = 0x1528;
   constexpr ptrdiff_t m_iIDEntIndex = 0x152c;
   constexpr ptrdiff_t m_delayTargetIDTimer = 0x1530;
   constexpr ptrdiff_t m_iTargetedWeaponEntIndex = 0x1548;
   constexpr ptrdiff_t m_iOldIDEntIndex = 0x154c;
   constexpr ptrdiff_t m_holdTargetIDTimer = 0x1550;
   constexpr ptrdiff_t m_flCurrentMusicStartTime = 0x156c;
   constexpr ptrdiff_t m_flMusicRoundStartTime = 0x1570;
   constexpr ptrdiff_t m_bDeferStartMusicOnWarmup = 0x1574;
   constexpr ptrdiff_t m_cycleLatch = 0x1578;
   constexpr ptrdiff_t m_serverIntendedCycle = 0x157c;
   constexpr ptrdiff_t m_vecPlayerPatchEconIndices = 0x1580;
   constexpr ptrdiff_t m_bHideTargetID = 0x159c;
   constexpr ptrdiff_t m_nextTaserShakeTime = 0x15a0;
   constexpr ptrdiff_t m_firstTaserShakeTime = 0x15a4;
   constexpr ptrdiff_t m_flLastSmokeOverlayAlpha = 0x15a8;
   constexpr ptrdiff_t m_vLastSmokeOverlayColor = 0x15ac;
   constexpr ptrdiff_t m_nPlayerSmokedFx = 0x15b8;
   constexpr ptrdiff_t m_flNextMagDropTime = 0x15bc;
   constexpr ptrdiff_t m_nLastMagDropAttachmentIndex = 0x15c0;
   constexpr ptrdiff_t m_vecBulletHitModels = 0x15c8;
   constexpr ptrdiff_t m_vecPickupModelSlerpers = 0x15e0;
   constexpr ptrdiff_t m_vecLastAliveLocalVelocity = 0x15f8;
   constexpr ptrdiff_t m_entitySpottedState = 0x1620;
   constexpr ptrdiff_t m_nSurvivalTeamNumber = 0x1638;
   constexpr ptrdiff_t m_bGuardianShouldSprayCustomXMark = 0x163c;
   constexpr ptrdiff_t m_bHasDeathInfo = 0x163d;
   constexpr ptrdiff_t m_flDeathInfoTime = 0x1640;
   constexpr ptrdiff_t m_vecDeathInfoOrigin = 0x1644;
   constexpr ptrdiff_t m_bKilledByHeadshot = 0x1650;
   constexpr ptrdiff_t m_hOriginalController = 0x1654;

}

namespace C_CSObserverPawn {

   constexpr ptrdiff_t m_hDetectParentChange = 0x16a0;

}

namespace C_CSPlayerPawn {

   constexpr ptrdiff_t m_pBulletServices = 0x16a0;
   constexpr ptrdiff_t m_pHostageServices = 0x16a8;
   constexpr ptrdiff_t m_pBuyServices = 0x16b0;
   constexpr ptrdiff_t m_pGlowServices = 0x16b8;
   constexpr ptrdiff_t m_pActionTrackingServices = 0x16c0;
   constexpr ptrdiff_t m_flHealthShotBoostExpirationTime = 0x16c8;
   constexpr ptrdiff_t m_flLastFiredWeaponTime = 0x16cc;
   constexpr ptrdiff_t m_bHasFemaleVoice = 0x16d0;
   constexpr ptrdiff_t m_flLandseconds = 0x16d4;
   constexpr ptrdiff_t m_flOldFallVelocity = 0x16d8;
   constexpr ptrdiff_t m_szLastPlaceName = 0x16dc;
   constexpr ptrdiff_t m_bPrevDefuser = 0x16ee;
   constexpr ptrdiff_t m_bPrevHelmet = 0x16ef;
   constexpr ptrdiff_t m_nPrevArmorVal = 0x16f0;
   constexpr ptrdiff_t m_nPrevGrenadeAmmoCount = 0x16f4;
   constexpr ptrdiff_t m_unPreviousWeaponHash = 0x16f8;
   constexpr ptrdiff_t m_unWeaponHash = 0x16fc;
   constexpr ptrdiff_t m_bInBuyZone = 0x1700;
   constexpr ptrdiff_t m_bPreviouslyInBuyZone = 0x1701;
   constexpr ptrdiff_t m_aimPunchAngle = 0x1704;
   constexpr ptrdiff_t m_aimPunchAngleVel = 0x1710;
   constexpr ptrdiff_t m_aimPunchTickBase = 0x171c;
   constexpr ptrdiff_t m_aimPunchTickFraction = 0x1720;
   constexpr ptrdiff_t m_aimPunchCache = 0x1728;
   constexpr ptrdiff_t m_bInLanding = 0x1748;
   constexpr ptrdiff_t m_flLandingTime = 0x174c;
   constexpr ptrdiff_t m_bInHostageRescueZone = 0x1750;
   constexpr ptrdiff_t m_bInBombZone = 0x1751;
   constexpr ptrdiff_t m_bIsBuyMenuOpen = 0x1752;
   constexpr ptrdiff_t m_flTimeOfLastInjury = 0x1754;
   constexpr ptrdiff_t m_flNextSprayDecalTime = 0x1758;
   constexpr ptrdiff_t m_iRetakesOffering = 0x1870;
   constexpr ptrdiff_t m_iRetakesOfferingCard = 0x1874;
   constexpr ptrdiff_t m_bRetakesHasDefuseKit = 0x1878;
   constexpr ptrdiff_t m_bRetakesMVPLastRound = 0x1879;
   constexpr ptrdiff_t m_iRetakesMVPBoostItem = 0x187c;
   constexpr ptrdiff_t m_RetakesMVPBoostExtraUtility = 0x1880;
   constexpr ptrdiff_t m_bNeedToReApplyGloves = 0x18a0;
   constexpr ptrdiff_t m_EconGloves = 0x18a8;
   constexpr ptrdiff_t m_bMustSyncRagdollState = 0x1cf0;
   constexpr ptrdiff_t m_nRagdollDamageBone = 0x1cf4;
   constexpr ptrdiff_t m_vRagdollDamageForce = 0x1cf8;
   constexpr ptrdiff_t m_vRagdollDamagePosition = 0x1d04;
   constexpr ptrdiff_t m_szRagdollDamageWeaponName = 0x1d10;
   constexpr ptrdiff_t m_bRagdollDamageHeadshot = 0x1d50;
   constexpr ptrdiff_t m_bLastHeadBoneTransformIsValid = 0x2290;
   constexpr ptrdiff_t m_lastLandTime = 0x2294;
   constexpr ptrdiff_t m_bOnGroundLastTick = 0x2298;
   constexpr ptrdiff_t m_qDeathEyeAngles = 0x22b4;
   constexpr ptrdiff_t m_bSkipOneHeadConstraintUpdate = 0x22c0;
...
namespace C_CSGO_PreviewPlayer {
   ...
   constexpr ptrdiff_t m_animgraph = 0x22c8;
   constexpr ptrdiff_t m_animgraphCharacterModeString = 0x22d0;
   constexpr ptrdiff_t m_flInitialModelScale = 0x22d8;

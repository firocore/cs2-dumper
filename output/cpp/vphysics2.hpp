...
namespace RnHull_t {
   ...
   constexpr ptrdiff_t m_Edges = 0x80;
   constexpr ptrdiff_t m_Faces = 0x98;
   constexpr ptrdiff_t m_Planes = 0xb0;
   constexpr ptrdiff_t m_nFlags = 0xc8;
   constexpr ptrdiff_t m_pRegionSVM = 0xd0;

...
class C_Inferno:
   ...
   m_firePositions: int = 3332
   m_fireParentPositions: int = 4100
...
class C_PlantedC4:
   ...
   m_bTriggerWarning: int = 3776
   m_bExplodeWarning: int = 3780
   m_bC4Activated: int = 3784
   m_bTenSecWarning: int = 3785
   m_flDefuseLength: int = 3788
   m_flDefuseCountDown: int = 3792
   m_bBombDefused: int = 3796
   m_hBombDefuser: int = 3800
   m_hControlPanel: int = 3804
   m_hDefuserMultimeter: int = 3808
   m_flNextRadarFlashTime: int = 3812
   m_bRadarFlash: int = 3816
   m_pBombDefuser: int = 3820
   m_fLastDefuseTime: int = 3824
...
class C_CSWeaponBase:
   ...
   m_bVisualsDataSet: int = 5928
   m_bOldFirstPersonSpectatedState: int = 5929
   m_hOurPing: int = 5932
   m_nOurPingIndex: int = 5936
   m_vecOurPingPos: int = 5940
   m_bGlowForPing: int = 5952
   m_bUIWeapon: int = 5953
   m_hPrevOwner: int = 5968
   m_nDropTick: int = 5972
   m_donated: int = 6004
   m_fLastShotTime: int = 6008
   m_bWasOwnedByCT: int = 6012
   m_bWasOwnedByTerrorist: int = 6013
   m_gunHeat: int = 6016
   m_smokeAttachments: int = 6020
   m_lastSmokeTime: int = 6024
   m_flLastClientFireBulletTime: int = 6028
...
class C_CSPlayerPawnBase:
   ...
   m_fMolotovUseTime: int = 5032
   m_fMolotovDamageTime: int = 5036
   m_nWhichBombZone: int = 5040
   m_bInNoDefuseArea: int = 5044
   m_iThrowGrenadeCounter: int = 5048
   m_bWaitForNoAttack: int = 5052
   m_flGuardianTooFarDistFrac: int = 5056
   m_flDetectedByEnemySensorTime: int = 5060
   m_flNextGuardianTooFarWarning: int = 5064
   m_bSuppressGuardianTooFarWarningAudio: int = 5068
   m_bKilledByTaser: int = 5069
   m_iMoveState: int = 5072
   m_bCanMoveDuringFreezePeriod: int = 5076
   m_flLowerBodyYawTarget: int = 5080
   m_bStrafing: int = 5084
   m_flLastSpawnTimeIndex: int = 5088
   m_flEmitSoundTime: int = 5092
   m_iAddonBits: int = 5096
   m_iPrimaryAddon: int = 5100
   m_iSecondaryAddon: int = 5104
   m_iProgressBarDuration: int = 5108
   m_flProgressBarStartTime: int = 5112
   m_iDirection: int = 5116
   m_iShotsFired: int = 5120
   m_bNightVisionOn: int = 5124
   m_bHasNightVision: int = 5125
   m_flVelocityModifier: int = 5128
   m_flHitHeading: int = 5132
   m_nHitBodyPart: int = 5136
   m_iStartAccount: int = 5140
   m_vecIntroStartEyePosition: int = 5144
   m_vecIntroStartPlayerForward: int = 5156
   m_flClientDeathTime: int = 5168
   m_flNightVisionAlpha: int = 5172
   m_bScreenTearFrameCaptured: int = 5176
   m_flFlashBangTime: int = 5180
   m_flFlashScreenshotAlpha: int = 5184
   m_flFlashOverlayAlpha: int = 5188
   m_bFlashBuildUp: int = 5192
   m_bFlashDspHasBeenCleared: int = 5193
   m_bFlashScreenshotHasBeenGrabbed: int = 5194
   m_flFlashMaxAlpha: int = 5196
   m_flFlashDuration: int = 5200
   m_lastStandingPos: int = 5204
   m_vecLastMuzzleFlashPos: int = 5216
   m_angLastMuzzleFlashAngle: int = 5228
   m_hMuzzleFlashShape: int = 5240
   m_iHealthBarRenderMaskIndex: int = 5244
   m_flHealthFadeValue: int = 5248
   m_flHealthFadeAlpha: int = 5252
   m_nMyCollisionGroup: int = 5256
   m_ignoreLadderJumpTime: int = 5260
   m_ladderSurpressionTimer: int = 5264
   m_lastLadderNormal: int = 5288
   m_lastLadderPos: int = 5300
   m_flDeathCCWeight: int = 5320
   m_bOldIsScoped: int = 5324
   m_flPrevRoundEndTime: int = 5328
   m_flPrevMatchEndTime: int = 5332
   m_unCurrentEquipmentValue: int = 5336
   m_unRoundStartEquipmentValue: int = 5338
   m_unFreezetimeEndEquipmentValue: int = 5340
   m_vecThirdPersonViewPositionOverride: int = 5344
   m_nHeavyAssaultSuitCooldownRemaining: int = 5356
   m_ArmorValue: int = 5360
   m_angEyeAngles: int = 5368
   m_fNextThinkPushAway: int = 5392
   m_bShouldAutobuyDMWeapons: int = 5396
   m_bShouldAutobuyNow: int = 5397
   m_bHud_MiniScoreHidden: int = 5398
   m_bHud_RadarHidden: int = 5399
   m_nLastKillerIndex: int = 5400
   m_nLastConcurrentKilled: int = 5404
   m_nDeathCamMusic: int = 5408
   m_iIDEntIndex: int = 5412
   m_delayTargetIDTimer: int = 5416
   m_iTargetedWeaponEntIndex: int = 5440
   m_iOldIDEntIndex: int = 5444
   m_holdTargetIDTimer: int = 5448
   m_flCurrentMusicStartTime: int = 5476
   m_flMusicRoundStartTime: int = 5480
   m_bDeferStartMusicOnWarmup: int = 5484
   m_cycleLatch: int = 5488
   m_serverIntendedCycle: int = 5492
   m_vecPlayerPatchEconIndices: int = 5496
   m_bHideTargetID: int = 5524
   m_nextTaserShakeTime: int = 5528
   m_firstTaserShakeTime: int = 5532
   m_flLastSmokeOverlayAlpha: int = 5536
   m_vLastSmokeOverlayColor: int = 5540
   m_nPlayerSmokedFx: int = 5552
   m_flNextMagDropTime: int = 5556
   m_nLastMagDropAttachmentIndex: int = 5560
   m_vecBulletHitModels: int = 5568
   m_vecPickupModelSlerpers: int = 5592
   m_vecLastAliveLocalVelocity: int = 5616
   m_entitySpottedState: int = 5656
   m_nSurvivalTeamNumber: int = 5680
   m_bGuardianShouldSprayCustomXMark: int = 5684
   m_bHasDeathInfo: int = 5685
   m_flDeathInfoTime: int = 5688
   m_vecDeathInfoOrigin: int = 5692
   m_bKilledByHeadshot: int = 5704
   m_hOriginalController: int = 5708



class C_CSObserverPawn:

   m_hDetectParentChange: int = 5784



class C_CSPlayerPawn:

   m_pBulletServices: int = 5784
   m_pHostageServices: int = 5792
   m_pBuyServices: int = 5800
   m_pGlowServices: int = 5808
   m_pActionTrackingServices: int = 5816
   m_flHealthShotBoostExpirationTime: int = 5824
   m_flLastFiredWeaponTime: int = 5828
   m_bHasFemaleVoice: int = 5832
   m_flLandseconds: int = 5836
   m_flOldFallVelocity: int = 5840
   m_szLastPlaceName: int = 5844
   m_bPrevDefuser: int = 5862
   m_bPrevHelmet: int = 5863
   m_nPrevArmorVal: int = 5864
   m_nPrevGrenadeAmmoCount: int = 5868
   m_unPreviousWeaponHash: int = 5872
   m_unWeaponHash: int = 5876
   m_bInBuyZone: int = 5880
   m_bPreviouslyInBuyZone: int = 5881
   m_aimPunchAngle: int = 5884
   m_aimPunchAngleVel: int = 5896
   m_aimPunchTickBase: int = 5908
   m_aimPunchTickFraction: int = 5912
   m_aimPunchCache: int = 5920
   m_bInLanding: int = 5952
   m_flLandingTime: int = 5956
   m_bInHostageRescueZone: int = 5960
   m_bInBombZone: int = 5961
   m_bIsBuyMenuOpen: int = 5962
   m_flTimeOfLastInjury: int = 5964
   m_flNextSprayDecalTime: int = 5968
   m_iRetakesOffering: int = 6248
   m_iRetakesOfferingCard: int = 6252
   m_bRetakesHasDefuseKit: int = 6256
   m_bRetakesMVPLastRound: int = 6257
   m_iRetakesMVPBoostItem: int = 6260
   m_RetakesMVPBoostExtraUtility: int = 6264
   m_bNeedToReApplyGloves: int = 6296
   m_EconGloves: int = 6304
   m_bMustSyncRagdollState: int = 7400
   m_nRagdollDamageBone: int = 7404
   m_vRagdollDamageForce: int = 7408
   m_vRagdollDamagePosition: int = 7420
   m_szRagdollDamageWeaponName: int = 7432
   m_bRagdollDamageHeadshot: int = 7496
   m_bLastHeadBoneTransformIsValid: int = 8840
   m_lastLandTime: int = 8844
   m_bOnGroundLastTick: int = 8848
   m_qDeathEyeAngles: int = 8876
   m_bSkipOneHeadConstraintUpdate: int = 8888
...
class C_CSGO_PreviewPlayer:
   ...
   m_animgraph: int = 8896
   m_animgraphCharacterModeString: int = 8904
   m_flInitialModelScale: int = 8912
...
class CCSPlayerController_ActionTrackingServices:
   ...
   m_unTotalRoundDamageDealt: int = 272

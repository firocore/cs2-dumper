...
public static class C_Inferno {
   ...
   public const nint m_firePositions = 0xd04;
   public const nint m_fireParentPositions = 0x1004;
...
public static class C_PlantedC4 {
   ...
   public const nint m_bTriggerWarning = 0xec0;
   public const nint m_bExplodeWarning = 0xec4;
   public const nint m_bC4Activated = 0xec8;
   public const nint m_bTenSecWarning = 0xec9;
   public const nint m_flDefuseLength = 0xecc;
   public const nint m_flDefuseCountDown = 0xed0;
   public const nint m_bBombDefused = 0xed4;
   public const nint m_hBombDefuser = 0xed8;
   public const nint m_hControlPanel = 0xedc;
   public const nint m_hDefuserMultimeter = 0xee0;
   public const nint m_flNextRadarFlashTime = 0xee4;
   public const nint m_bRadarFlash = 0xee8;
   public const nint m_pBombDefuser = 0xeec;
   public const nint m_fLastDefuseTime = 0xef0;
...
public static class C_CSWeaponBase {
   ...
   public const nint m_bVisualsDataSet = 0x1728;
   public const nint m_bOldFirstPersonSpectatedState = 0x1729;
   public const nint m_hOurPing = 0x172c;
   public const nint m_nOurPingIndex = 0x1730;
   public const nint m_vecOurPingPos = 0x1734;
   public const nint m_bGlowForPing = 0x1740;
   public const nint m_bUIWeapon = 0x1741;
   public const nint m_hPrevOwner = 0x1750;
   public const nint m_nDropTick = 0x1754;
   public const nint m_donated = 0x1774;
   public const nint m_fLastShotTime = 0x1778;
   public const nint m_bWasOwnedByCT = 0x177c;
   public const nint m_bWasOwnedByTerrorist = 0x177d;
   public const nint m_gunHeat = 0x1780;
   public const nint m_smokeAttachments = 0x1784;
   public const nint m_lastSmokeTime = 0x1788;
   public const nint m_flLastClientFireBulletTime = 0x178c;
...
public static class C_CSPlayerPawnBase {
   ...
   public const nint m_fMolotovUseTime = 0x13a8;
   public const nint m_fMolotovDamageTime = 0x13ac;
   public const nint m_nWhichBombZone = 0x13b0;
   public const nint m_bInNoDefuseArea = 0x13b4;
   public const nint m_iThrowGrenadeCounter = 0x13b8;
   public const nint m_bWaitForNoAttack = 0x13bc;
   public const nint m_flGuardianTooFarDistFrac = 0x13c0;
   public const nint m_flDetectedByEnemySensorTime = 0x13c4;
   public const nint m_flNextGuardianTooFarWarning = 0x13c8;
   public const nint m_bSuppressGuardianTooFarWarningAudio = 0x13cc;
   public const nint m_bKilledByTaser = 0x13cd;
   public const nint m_iMoveState = 0x13d0;
   public const nint m_bCanMoveDuringFreezePeriod = 0x13d4;
   public const nint m_flLowerBodyYawTarget = 0x13d8;
   public const nint m_bStrafing = 0x13dc;
   public const nint m_flLastSpawnTimeIndex = 0x13e0;
   public const nint m_flEmitSoundTime = 0x13e4;
   public const nint m_iAddonBits = 0x13e8;
   public const nint m_iPrimaryAddon = 0x13ec;
   public const nint m_iSecondaryAddon = 0x13f0;
   public const nint m_iProgressBarDuration = 0x13f4;
   public const nint m_flProgressBarStartTime = 0x13f8;
   public const nint m_iDirection = 0x13fc;
   public const nint m_iShotsFired = 0x1400;
   public const nint m_bNightVisionOn = 0x1404;
   public const nint m_bHasNightVision = 0x1405;
   public const nint m_flVelocityModifier = 0x1408;
   public const nint m_flHitHeading = 0x140c;
   public const nint m_nHitBodyPart = 0x1410;
   public const nint m_iStartAccount = 0x1414;
   public const nint m_vecIntroStartEyePosition = 0x1418;
   public const nint m_vecIntroStartPlayerForward = 0x1424;
   public const nint m_flClientDeathTime = 0x1430;
   public const nint m_flNightVisionAlpha = 0x1434;
   public const nint m_bScreenTearFrameCaptured = 0x1438;
   public const nint m_flFlashBangTime = 0x143c;
   public const nint m_flFlashScreenshotAlpha = 0x1440;
   public const nint m_flFlashOverlayAlpha = 0x1444;
   public const nint m_bFlashBuildUp = 0x1448;
   public const nint m_bFlashDspHasBeenCleared = 0x1449;
   public const nint m_bFlashScreenshotHasBeenGrabbed = 0x144a;
   public const nint m_flFlashMaxAlpha = 0x144c;
   public const nint m_flFlashDuration = 0x1450;
   public const nint m_lastStandingPos = 0x1454;
   public const nint m_vecLastMuzzleFlashPos = 0x1460;
   public const nint m_angLastMuzzleFlashAngle = 0x146c;
   public const nint m_hMuzzleFlashShape = 0x1478;
   public const nint m_iHealthBarRenderMaskIndex = 0x147c;
   public const nint m_flHealthFadeValue = 0x1480;
   public const nint m_flHealthFadeAlpha = 0x1484;
   public const nint m_nMyCollisionGroup = 0x1488;
   public const nint m_ignoreLadderJumpTime = 0x148c;
   public const nint m_ladderSurpressionTimer = 0x1490;
   public const nint m_lastLadderNormal = 0x14a8;
   public const nint m_lastLadderPos = 0x14b4;
   public const nint m_flDeathCCWeight = 0x14c8;
   public const nint m_bOldIsScoped = 0x14cc;
   public const nint m_flPrevRoundEndTime = 0x14d0;
   public const nint m_flPrevMatchEndTime = 0x14d4;
   public const nint m_unCurrentEquipmentValue = 0x14d8;
   public const nint m_unRoundStartEquipmentValue = 0x14da;
   public const nint m_unFreezetimeEndEquipmentValue = 0x14dc;
   public const nint m_vecThirdPersonViewPositionOverride = 0x14e0;
   public const nint m_nHeavyAssaultSuitCooldownRemaining = 0x14ec;
   public const nint m_ArmorValue = 0x14f0;
   public const nint m_angEyeAngles = 0x14f8;
   public const nint m_fNextThinkPushAway = 0x1510;
   public const nint m_bShouldAutobuyDMWeapons = 0x1514;
   public const nint m_bShouldAutobuyNow = 0x1515;
   public const nint m_bHud_MiniScoreHidden = 0x1516;
   public const nint m_bHud_RadarHidden = 0x1517;
   public const nint m_nLastKillerIndex = 0x1518;
   public const nint m_nLastConcurrentKilled = 0x151c;
   public const nint m_nDeathCamMusic = 0x1520;
   public const nint m_iIDEntIndex = 0x1524;
   public const nint m_delayTargetIDTimer = 0x1528;
   public const nint m_iTargetedWeaponEntIndex = 0x1540;
   public const nint m_iOldIDEntIndex = 0x1544;
   public const nint m_holdTargetIDTimer = 0x1548;
   public const nint m_flCurrentMusicStartTime = 0x1564;
   public const nint m_flMusicRoundStartTime = 0x1568;
   public const nint m_bDeferStartMusicOnWarmup = 0x156c;
   public const nint m_cycleLatch = 0x1570;
   public const nint m_serverIntendedCycle = 0x1574;
   public const nint m_vecPlayerPatchEconIndices = 0x1578;
   public const nint m_bHideTargetID = 0x1594;
   public const nint m_nextTaserShakeTime = 0x1598;
   public const nint m_firstTaserShakeTime = 0x159c;
   public const nint m_flLastSmokeOverlayAlpha = 0x15a0;
   public const nint m_vLastSmokeOverlayColor = 0x15a4;
   public const nint m_nPlayerSmokedFx = 0x15b0;
   public const nint m_flNextMagDropTime = 0x15b4;
   public const nint m_nLastMagDropAttachmentIndex = 0x15b8;
   public const nint m_vecBulletHitModels = 0x15c0;
   public const nint m_vecPickupModelSlerpers = 0x15d8;
   public const nint m_vecLastAliveLocalVelocity = 0x15f0;
   public const nint m_entitySpottedState = 0x1618;
   public const nint m_nSurvivalTeamNumber = 0x1630;
   public const nint m_bGuardianShouldSprayCustomXMark = 0x1634;
   public const nint m_bHasDeathInfo = 0x1635;
   public const nint m_flDeathInfoTime = 0x1638;
   public const nint m_vecDeathInfoOrigin = 0x163c;
   public const nint m_bKilledByHeadshot = 0x1648;
   public const nint m_hOriginalController = 0x164c;

}

public static class C_CSObserverPawn {

   public const nint m_hDetectParentChange = 0x1698;

}

public static class C_CSPlayerPawn {

   public const nint m_pBulletServices = 0x1698;
   public const nint m_pHostageServices = 0x16a0;
   public const nint m_pBuyServices = 0x16a8;
   public const nint m_pGlowServices = 0x16b0;
   public const nint m_pActionTrackingServices = 0x16b8;
   public const nint m_flHealthShotBoostExpirationTime = 0x16c0;
   public const nint m_flLastFiredWeaponTime = 0x16c4;
   public const nint m_bHasFemaleVoice = 0x16c8;
   public const nint m_flLandseconds = 0x16cc;
   public const nint m_flOldFallVelocity = 0x16d0;
   public const nint m_szLastPlaceName = 0x16d4;
   public const nint m_bPrevDefuser = 0x16e6;
   public const nint m_bPrevHelmet = 0x16e7;
   public const nint m_nPrevArmorVal = 0x16e8;
   public const nint m_nPrevGrenadeAmmoCount = 0x16ec;
   public const nint m_unPreviousWeaponHash = 0x16f0;
   public const nint m_unWeaponHash = 0x16f4;
   public const nint m_bInBuyZone = 0x16f8;
   public const nint m_bPreviouslyInBuyZone = 0x16f9;
   public const nint m_aimPunchAngle = 0x16fc;
   public const nint m_aimPunchAngleVel = 0x1708;
   public const nint m_aimPunchTickBase = 0x1714;
   public const nint m_aimPunchTickFraction = 0x1718;
   public const nint m_aimPunchCache = 0x1720;
   public const nint m_bInLanding = 0x1740;
   public const nint m_flLandingTime = 0x1744;
   public const nint m_bInHostageRescueZone = 0x1748;
   public const nint m_bInBombZone = 0x1749;
   public const nint m_bIsBuyMenuOpen = 0x174a;
   public const nint m_flTimeOfLastInjury = 0x174c;
   public const nint m_flNextSprayDecalTime = 0x1750;
   public const nint m_iRetakesOffering = 0x1868;
   public const nint m_iRetakesOfferingCard = 0x186c;
   public const nint m_bRetakesHasDefuseKit = 0x1870;
   public const nint m_bRetakesMVPLastRound = 0x1871;
   public const nint m_iRetakesMVPBoostItem = 0x1874;
   public const nint m_RetakesMVPBoostExtraUtility = 0x1878;
   public const nint m_bNeedToReApplyGloves = 0x1898;
   public const nint m_EconGloves = 0x18a0;
   public const nint m_bMustSyncRagdollState = 0x1ce8;
   public const nint m_nRagdollDamageBone = 0x1cec;
   public const nint m_vRagdollDamageForce = 0x1cf0;
   public const nint m_vRagdollDamagePosition = 0x1cfc;
   public const nint m_szRagdollDamageWeaponName = 0x1d08;
   public const nint m_bRagdollDamageHeadshot = 0x1d48;
   public const nint m_bLastHeadBoneTransformIsValid = 0x2288;
   public const nint m_lastLandTime = 0x228c;
   public const nint m_bOnGroundLastTick = 0x2290;
   public const nint m_qDeathEyeAngles = 0x22ac;
   public const nint m_bSkipOneHeadConstraintUpdate = 0x22b8;
...
public static class C_CSGO_PreviewPlayer {
   ...
   public const nint m_animgraph = 0x22c0;
   public const nint m_animgraphCharacterModeString = 0x22c8;
   public const nint m_flInitialModelScale = 0x22d0;
...
public static class CCSPlayerController_ActionTrackingServices {
   ...
   public const nint m_unTotalRoundDamageDealt = 0x110;
